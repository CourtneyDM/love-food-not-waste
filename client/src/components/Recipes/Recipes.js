            ...
            <section id="recipes" className="section-bg" >
                ...
                <div className="container">
                    ...
                    <header className="section-header">
                        ...
                        {
                            !isAuthenticated() && (
                                <a className="cta-btn" href="#" onClick={this.login.bind(this)}>More Recipes</a>
                            )
                        }
                        {
                            isAuthenticated() && (
                    ...
                    <div className="row portfolio-container">
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe1-detail.jpg" className="link-preview" data-lightbox="recipes" data-title="Nearly Sour Milk" title="Preview">Nearly Sour Milk</a></h4>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe2-detail.jpg" className="link-preview" data-lightbox="recipes" data-title="Overripe Avocados" title="Preview">Overripe Avocados</a></h4>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe3-detail.jpg" className="link-preview" data-lightbox="recipes" data-title="Chicken Bones" title="Preview">Chicken Bones</a></h4>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe4-detail.jpg" className="link-preview" data-lightbox="recipes" data-title="Potato Peels" title="Preview">Potato Peels</a></h4>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe5-detail.jpg" className="link-preview"  data-lightbox="recipes" data-title="Yogurt" title="Preview">Yogurt</a></h4>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe6-detail.jpg" className="link-preview" data-lightbox="recipes" data-title="Stale Bread" title="Preview">Stale Bread</a></h4>
                                    <p>Panzanella</p>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe7-detail.jpg" className="link-preview" data-lightbox="recipes" data-title="Cheese Rinds" title="Preview">Cheese Rinds</a></h4>
                                    <p>Fromage Fort</p>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp" data-wow-delay="0.1s">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe8-detail.jpg" className="link-preview" data-lightbox="recipes" data-title="Onions, Herbs, Veggies, Potatoes" title="Preview">Onions, Herbs, Veggies, Potatoes</a></h4>
                                    <p>Scraps Falafel</p>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    <h4><a href="/assets/images/recipes/recipe9-detail.jpg" className="link-preview" data-lightbox="recipes" data-title="Browned Bananas">Browned Bananas</a></h4>
                                    <p>Banana Bread</p>
                                </div>
                            </div>
